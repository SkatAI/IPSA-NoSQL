...
La méthode `find()` appliquée à une collection ne permet pas de fairre des requetes complexes. Par exemple elle ne permet pas de regrouper ou de transformer les documents.
